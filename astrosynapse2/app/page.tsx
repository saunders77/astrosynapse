...
const jargon = {
  ...
  safetyTruncations: "Games stopped by a turn or action safety limit instead of ending normally. They are excluded from learning and cannot promote a model; lower is generally better.",
  ...
  durableResume: "A durable resume restores optimizer momentum and a replay sample together with model weights, avoiding a hidden training reset after interruption.",
} as const;
    ...
    try {
      ...
      showToast(
        action === "checkpoint"
          ...
          : action === "pause"
            ? `Pause requested${connected ? " · draining current rollout batch" : " in demo mode"}`
