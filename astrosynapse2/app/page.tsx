...
const jargon = {
  ...
  selfPlay: "Games generated by the accepted champion. The separate learner candidate cannot steer ordinary rollouts until it passes promotion.",
                ...
                {advancedOpen ? (
                  <div className="advanced-fields">
                    ...
                    <div className="field-section"><h3>Replay & exploration</h3><div className="field-grid">
                      ...
                      <label><span>Exploration top-k</span><input type="number" min="1" max="16" value={config.explorationTopK} onChange={(event) => updateConfig("explorationTopK", Number(event.target.value))} /></label>
                    ...
                    <div className="field-section"><h3>Curriculum, league & promotion</h3><div className="field-grid">
                      ...
                      <label><span><Jargon term="selfPlay">Champion self-play</Jargon></span><input type="number" min="0" max="1" step="0.01" value={config.currentSelfplayFraction} onChange={(event) => updateConfig("currentSelfplayFraction", Number(event.target.value))} /></label>
        ...
        {activeTab === "diagnostics" ? (
          <section className="tab-panel diagnostics-panel" aria-labelledby="diagnostics-title">
            ...
            <div className="diagnostic-grid">
              ...
              })}</div>{!replayFamilyEntries.length ? <EmptyState title="Replay is warming up" detail="Per-family occupancy appears after the first self-play batches." /> : null}<p className="panel-note">Capacity and learner sampling follow decision frequency while reserving explicit coverage for rare tactical families.</p></article>
            ...
            <div className="settings-audit-grid">
              <form className="panel live-settings" onSubmit={saveLiveConfig}>
                ...
                <div className="field-grid">
                  ...
                  <label><span><Jargon term="selfPlay">Champion self-play</Jargon></span><input type="number" step="0.01" value={config.currentSelfplayFraction} onChange={(event) => updateConfig("currentSelfplayFraction", Number(event.target.value))} /></label>
